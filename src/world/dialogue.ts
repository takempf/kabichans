...
export const DIALOGUE_TOPICS: readonly {
...
}[] = [
  {
    ...
    lines: [
      ...
      'Mommy is staring at the glow rectangle.',
      'I sat on her rectangle. Now look at me.',
      ['Why look at that glowing rectangle?', 'My little face is right here!'],
      'The TV rectangle is too big and loud.',
      'No rectangles. Only cuddles.',
      'Pet me, not the flat glowing rectangle.',
    ],
  },
  {
    id: 'food',
    ...
    lines: [
      ...
      'A bowl of crunchy pellets awaits.',
      ['One pellet rolled under the stove.', 'It is in the underworld now.'],
      'I batted a dry pellet across the rug.',
      'Fish-shaped pellets are the tastiest.',
      'Pellets taste best when scattered.',
    ],
  },
  {
    id: 'vomiting',
  ...
  },
  {
    ...
    lines: [
      ...
      'The string toy is wiggling!',
      ['Look out, a wild snake!', 'Wait. It is just the string toy.'],
      'The yarn snake slithered in the grass.',
      'I pounced on the sneaky string snake.',
      'The red dot is back in the meadow!',
      'I almost trapped the laser this time.',
      ['Where did the red laser go?', 'It vanished into the ground!'],
      'Mommy said LASER is an acronym.',
      ['What does LASER stand for?', 'Look! A Scam Evading Real-paws.'],
      'LASER means Leap And Sprint Everywhere.',
      [
        'Did you know LASER is an acronym?',
        'I thought it meant Lost Another Snack.',
      ],
    ],
  },
  {
